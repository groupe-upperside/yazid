...
export default async function Header({ doc, lang }: HeaderProps) {
  ...
  const dropdownCart = await client.getSingle('dropdown_cart', { lang });
  ...
  return (
    <header>
      ...
      <nav className="relative mb-6 mt-4 border-gray-200 bg-white p-2 md:px-12 lg:px-14 2xl:mb-14 2xl:mt-8 2xl:px-20">
        <div className="mx-auto flex flex-wrap items-center justify-between">
          <Drawer meta={meta} footer={footer} locales={locales} />
          <div className="absolute left-1/2 -translate-x-1/2">
            <PrismicNextLink field={meta.data.home_link}>
              <PrismicNextImage className="xl:h-18 h-12 w-auto md:h-16 2xl:h-20" field={meta.data.og_image} />
            </PrismicNextLink>
          </div>

          <div className="flex items-center justify-between md:gap-x-4 lg:flex lg:w-auto" id="mobile-menu-2">
            ...
            <CartDropdown lang={lang} meta={dropdownCart} />
